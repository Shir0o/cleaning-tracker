...
void main() {
  group('LogHistoryPage Scenario Tests', () {
    testWidgets('User scales text up and down, layout still constrains', (WidgetTester tester) async {
    ...
    testWidgets('User scrolls through the archive list', (WidgetTester tester) async {
